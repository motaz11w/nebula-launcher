<template>
  ...
  >
    ...
    <v-card
      ...
      style="width: 100%"
      to="https://github.com/error/nebula-launcher/releases"
      target="browser"
      push
    >
...
const openOfficialWebsite = () => {
  window.open('https://www.nebulapp.duckdns.org/', 'browser')
}
const openGithub = () => {
  window.open('https://github.com/error/nebula-launcher/releases', 'browser')
}
</script>
