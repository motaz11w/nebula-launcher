    ...
    <div class="mt-4 flex flex-col gap-3 items-center text-sm font-medium">
      ...
      >
        ...
        <div class="flex flex-col gap-1.5 pt-1">
          <a
            target="browser"
            href="https://www.nebulapp.duckdns.org/en/guide/microsoft-login-issues"
      ...
      operations: [
        {
          ...
          icon: 'help_outline',
          handler() {
            window.open('https://www.nebulapp.duckdns.org/en/guide/microsoft-login-issues', 'browser')
          },
        },
        {
          ...
          icon: 'xmcl:discord',
          handler() {
            window.open('https://discord.gg/55ddxAvFpt', 'browser')
          },
        },
      ],
    })
